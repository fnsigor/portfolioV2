...
export function SectionAbout() {
    ...
    return (
        <Content id='sobre'>
            ...
            <p>Em <span>2022</span> comecei essa jornada para me tornar um desenvolvedor Front-end. Atualmente estou buscando a primeira oportunidade no mercado de trabalho como desenvolvedor.</p>
        </Content>
    )
}